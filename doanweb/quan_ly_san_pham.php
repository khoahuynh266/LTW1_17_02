		...
		<ul class="pagination">
           ...
           <?php 
            ...
            if ($current_page > 1 && $total_page > 1){
                echo '<li class="page-item"><a class="page-link" href="quan_ly_san_pham.php?page='.($current_page-1).'">Prev</a></li>';
            }
            ...
            for ($i = 1; $i <= $total_page; $i++){
                ...
                if ($i == $current_page){
                    echo '   <li class="page-item disabled">
								<a class="page-link" href="quan_ly_san_pham.php?page='.$i.'">'.$i.'</a></li>';
                }
                else{
                    echo '<li class="page-item"><a class="page-link" href="quan_ly_san_pham.php?page='.$i.'">'.$i.'</a></li>';
                }
            }
            // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
            if ($current_page < $total_page && $total_page > 1){
                echo '<li class="page-item"><a class="page-link" href="quan_ly_san_pham.php?page='.($current_page+1).'">Next</a></li>';
            }
           ?>
			</ul>
		</nav>
