	...
	<div id="left">
		<div class="block">
			<div class="block_sidebar">
				<h6 href="">Danh sách sản phẩm theo nhà sản xuất</h6>
			</div>
				...
				<ul class="pagination">
				   ...
				   <?php 
					...
					if ($current_page > 1 && $total_page > 1){
						echo '<li class="page-item"><a class="page-link" href="danh_sach_theo_nsx.php?id='.$id.'&page='.($current_page-1).'">Prev</a></li>';
					}
					...
					for ($i = 1; $i <= $total_page; $i++){
						...
						if ($i == $current_page){
							echo '   <li class="page-item disabled">
										<a class="page-link" href="danh_sach_theo_nsx.php?id='.$id.'&page='.$i.'">'.$i.'</a></li>';
						}
						else{
							echo '<li class="page-item"><a class="page-link" href="danh_sach_theo_nsx.php?id='.$id.'&page='.$i.'">'.$i.'</a></li>';
						}
					}
					// nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
					if ($current_page < $total_page && $total_page > 1){
						echo '<li class="page-item"><a class="page-link" href="danh_sach_theo_nsx.php?id='.$id.'&page='.($current_page+1).'">Next</a></li>';
					}
				   ?>
					</ul>
			</nav>
	...
	<div id="right">
		<div class="block">
			...
			<?php foreach($resultSet3 as $row): ?>
				<ul>
					<li>
						<h5><a href="danh_sach_theo_nsx.php?id=<?php echo $row['id'] ?>"><?php echo $row['ten_loai'] ?></a></h5>
					</li>
				</ul>
			<?php endforeach; ?>
